        ...
        <div className="flex items-center">
            ...
            <div className="flex gap-[25px] screen-800:gap-[15px] screen-768:grid screen-768:grid-cols-2">
                <a 
                    ...
                    target="_blank" 
                    className='flex justify-center items-center rounded-[50%] w-[55px] h-[55px] bg-white shadow-md hover:scale-[1.2] transition-[100ms] cursor-pointer'
                >
                    <FaGithub className="text-[24px] hover:text-[#147efb] transition"/>
                </a>
                <a 
                    ...
                    className='flex justify-center items-center rounded-[50%] w-[55px] h-[55px] bg-white shadow-md hover:scale-[1.2] transition-[100ms] cursor-pointer'
                >
                    <FaLinkedin className="text-[24px] hover:text-[#147efb] transition"/>
                </a>
                <a 
                    ...
                    className='flex justify-center items-center rounded-[50%] w-[55px] h-[55px] bg-white shadow-md hover:scale-[1.2] transition-[100ms] cursor-pointer'
                >
                    <FaFileArrowDown className="text-[24px] hover:text-[#147efb] transition"/>
                </a>
            </div>
        </div>
    )
